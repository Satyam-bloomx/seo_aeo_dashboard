                        ...
                        {PRESETS.map((preset) => {
                          ...
                          return (
                            <motion.div
                              ...
                              whileTap={{ scale: 0.98 }}
                              transition={spring.press}
                              className={`p-4 rounded-xl border cursor-pointer relative flex flex-col justify-between ${
                                isSelected
                                  ? 'bg-indigo-50/70 border-indigo-400 shadow-xs ring-1 ring-indigo-400/30'
                                  : 'bg-slate-50/60 border-slate-200 hover:border-slate-300 hover:bg-slate-100/60'
                              }`}
                            >
